...
%                                                                                                   -->
%     NOTE:                                                                                         -->
%       - Miho Kita (Magn Reson Imaging, 2013) uses these T1 reference values for CSF and fat:      -->
%       - CSF:  4500 （4200-4700） @ 1.5 T;   4700 （4500-4900） @ 3.0 T                                 -->
%       - Fat:   260 （240-280）   @ 1.5 T;    340 （320-370）   @ 3.0 T                                 -->
%
%  TODO:
...
% User1 settings:                                   % 1.5*T (Custom): You can add your own times here.
    iC.S.U1.B0sys   =    1.5                        ;   % #.# T (numeric; used for display only)

    iC.S.U1.T1_WM   =  660.0                        ;   % 1.5 T GE code = 660 ms
    ...
    iC.S.U1.T1_Fat  =  192.0                        ;   % 1.5 T GE code = 192 ms
...
% User2 settings:                                   % 3.0*T (Custom): You can add your own times here.
    ...
    iC.S.U2.T1_WM   =  850.0                        ;   % 3.0 T GE code =  825 ms
    ...
    iC.S.U2.T1_Fat  =  250.0                        ;   % 3.0 T GE code =  250 ms
